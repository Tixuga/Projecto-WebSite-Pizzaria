    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        ...
        if(isset($_SESSION['id'])){
          ?><a href="index.php?p=pedir"><button type="button"
          class="btn btn-warning">Fazer Pedido</button></a>
          <a href="index.php?p=minhaConta"><button type="button"
          class="btn btn-warning">Minha Conta</button></a>
        <a href="index.php?p=logout"><button type="button"
